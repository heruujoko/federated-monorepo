...
type DirectiveRoot struct {
	Contact func(ctx context.Context, obj interface{}, next graphql.Resolver, name string, url *string, description *string) (res interface{}, err error)
}
...
type ComplexityRoot struct {
	...
	Entity struct {
		FindFooByID func(childComplexity int, id string) int
	}
	...
	Query struct {
		...
		Foo                func(childComplexity int, id string) int
...
type EntityResolver interface {
	FindFooByID(ctx context.Context, id string) (*model.Foo, error)
}
type QueryResolver interface {
	Foo(ctx context.Context, id string) (*model.Foo, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Entity.findFooByID":
		if e.complexity.Entity.FindFooByID == nil {
			break
		}

		args, err := ec.field_Entity_findFooByID_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Entity.FindFooByID(childComplexity, args["id"].(string)), true
	...
	case "Query.foo":
		...
		return e.complexity.Query.Foo(childComplexity, args["id"].(string)), true
...
func (ec *executionContext) dir_contact_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
...
func (ec *executionContext) field_Entity_findFooByID_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
...
func (ec *executionContext) _Customer_deleted_at(ctx context.Context, field graphql.CollectedField, obj *model.Customer) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Customer_deleted_at(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Customer_deleted_at(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Customer",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Entity_findFooByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Entity_findFooByID(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Entity().FindFooByID(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Entity_findFooByID(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "id":
				return ec.fieldContext_Foo_id(ctx, field)
			case "name":
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Entity_findFooByID_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Foo_name(ctx context.Context, field graphql.CollectedField, obj *model.Foo) (ret graphql.Marshaler) {
...
func (ec *executionContext) fieldContext_Foo_name(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Foo",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _Query_foo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Foo(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_customers(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "deleted_at":
				return ec.fieldContext_Customer_deleted_at(ctx, field)
			}
...
func (ec *executionContext) _Customer(ctx context.Context, sel ast.SelectionSet, obj *model.Customer) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "deleted_at":
			out.Values[i] = ec._Customer_deleted_at(ctx, field, obj)
		default:
	...
	for i, field := range fields {
		...
		case "findFooByID":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Entity_findFooByID(ctx, field)
				if res == graphql.Null {
...
var fooImplementors = []string{"Foo", "_Entity"}
...
func (ec *executionContext) unmarshalNTimestamp2timeᚐTime(ctx context.Context, v interface{}) (time.Time, error) {
	res, err := helpers.UnmarshalTimestamp(v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) marshalNTimestamp2timeᚐTime(ctx context.Context, sel ast.SelectionSet, v time.Time) graphql.Marshaler {
	res := helpers.MarshalTimestamp(v)
	if res == graphql.Null {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
